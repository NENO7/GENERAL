...
if [ "$1" = "install" ]; then
 ...
 ## chmod 777 config_fix.sh
  ...
  echo -e "       CH > @NENO_CH         " 
  echo -e "       CH > @NENO_CH          " 
  echo -e "       CH > @NENO_CH          \033[0;00m"
  echo -e "\e[36m"                                      
  echo -e "CH > @NENO_CH" 
   cat << EOF
 $f1   _____               Dev @KNSLTHM 
 $f1  |_   _|__|    / \    Dev @KNSLTHM
 $f1    | |/ __| '_ \  /   Dev @KNSLTHM
 $f1    | |\__ \ | | |/ __ Dev @KNSLTHM
 $f1    _/_/   \_\_|\_\____Dev @KNSLTHM
 $f1               CH > @lTSHAKEl_CH
EOF
echo -e "\e[100m          CH > @NENO_CH        \e[00;37;40m"
